...
p = re.compile("ca.e")
# . (ca.e)  : 하나의 문자를 의미 > care, case (o) | coffe(x)
...
# 4. lst = p.findall("비교할 문자열") : 일치하는 모든 것을 리스트 ㅎ령태로 반환
...
# google 에서 w3school/ run python/ regular expression
# python re 검색 python 공식 문서 페이지에서 공부
